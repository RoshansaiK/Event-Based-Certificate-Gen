...
// Fetch certificate details including username
$stmt = $conn->prepare("SELECT users.username, courses.title AS course_title
                        FROM certificates
    ...
    <div class="certificate-container">
        <div id="certificate" class="certificate">
            <div class="certificate-content">
                <h2 class="event">Talentevent</h2> <!-- Added Talentevent here -->
